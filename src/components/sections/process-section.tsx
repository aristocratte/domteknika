...
import {
  ProcessScrollCard,
  ProcessScrollScene,
} from "@/components/sections/process-scroll-scene";
      ...
      <ProcessScrollScene>
        <Container size="wide" className="max-w-[1200px] py-0">
          <div className="grid gap-4 lg:grid-cols-[1.05fr_1.12fr_1.05fr] lg:items-stretch lg:gap-0">
            <ProcessScrollCard index={0}>
              <article className="flex h-full min-h-[292px] flex-col justify-center rounded-[15px] border border-border bg-white p-6">
                <AccentLine />
            ...
            <ProcessScrollCard index={1}>
              <article className="relative z-20 my-0 h-full min-h-[292px] rounded-[15px] bg-brand px-6 py-7 text-white shadow-[0_24px_42px_rgba(0,0,0,0.24)] md:px-7 lg:-mx-2">
            ...
            <ProcessScrollCard index={2}>
              <article className="flex h-full min-h-[292px] flex-col justify-between overflow-hidden rounded-[15px] border border-border bg-white">
